...
<body>
    ...
    <main>
        <section class="directorBlog">
            <div class="blleft">
                <h1>BLOG</h1>
            </div>
            <div class="blright">
                <div class="bl1">
                    <img src="Images/Toys/nendoroids/ant.png">
                    <button><a href="blog2.php">NENDOROIDS</a></button>
                </div>

                <div class="bl2">
                    <img src="Images/Toys/otherBrands/gun.png">
                    <button><a href="blog1.php">OTHER</a></button>
                </div>
            </div>
        </section>
